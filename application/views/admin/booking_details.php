                                    ...
                                    <table class="table align-middle table-nowrap table-centered mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end">₱<?= number_format(($room['price'] * $booking['jumlah_malam']), 2, ",", ".") ?></td>
                                            </tr>
                                            <!-- end tr -->
                                            <tr>
                                            ...
                                            <tr>
                                                <th scope="row" colspan="4" class="border-0 text-end">
                                                    Service Charge</th>
                                                <td class="border-0 text-end">₱<?= number_format(ceil(($room['price'] * $booking['jumlah_malam']) * 0.05), 2, ",", ".") ?></td>
                                            </tr>
                                            <!-- end tr -->
                                            <tr>
                                                <th scope="row" colspan="4" class="border-0 text-end">
                                                    Tax</th>
                                                <td class="border-0 text-end">₱<?= number_format(ceil((($room['price'] * $booking['jumlah_malam']) + ceil(($room['price'] * $booking['jumlah_malam']) * 0.05)) * 0.1), 2, ",", ".") ?></td>
                                            </tr>
                                            <!-- end tr -->
                                            <tr>
                                                <th scope="row" colspan="4" class="border-0 text-end">Total</th>
                                                <td class="border-0 text-end">
                                                    <h4 class="m-0 fw-semibold">₱<?= number_format((($room['price'] * $booking['jumlah_malam']) + ceil(($room['price'] * $booking['jumlah_malam']) * 0.05) + ceil((($room['price'] * $booking['jumlah_malam']) + ceil(($room['price'] * $booking['jumlah_malam']) * 0.05)) * 0.1)), 2, ",", ".") ?></h4>
                                                </td>
                                            </tr>
                                            <!-- end tr -->
                                        </tbody><!-- end tbody -->
