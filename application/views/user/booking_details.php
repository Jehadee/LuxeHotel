                                    ...
                                    <table class="table align-middle table-nowrap table-centered mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>₱<?= number_format(($booking['harga_kamar']), 2, ",", ".") ?></td>
                                                <td><?= $booking['jumlah_malam'] ?></td>
                                                <td class="text-end">₱<?= number_format(($booking['harga_kamar'] * $booking['jumlah_malam']), 2, ",", ".") ?></td>
                                            </tr>
                                            <!-- end tr -->
                                            <tr>
                                            ...
                                            <tr>
                                                <th scope="row" colspan="4" class="border-0 text-end">
                                                    Service Charge</th>
                                                <td class="border-0 text-end">₱<?= number_format(($booking['service']), 2, ",", ".") ?></td>
                                            </tr>
                                            <!-- end tr -->
                                            <tr>
                                                <th scope="row" colspan="4" class="border-0 text-end">
                                                    Tax</th>
                                                <td class="border-0 text-end">₱<?= number_format(($booking['pajak']), 2, ",", ".") ?></td>
                                            </tr>
                                            <!-- end tr -->
                                            <tr>
                                                <th scope="row" colspan="4" class="border-0 text-end">Total</th>
                                                <td class="border-0 text-end">
                                                    <h4 class="m-0 fw-semibold">₱<?= number_format(($booking['total_harga']), 2, ",", ".") ?></h4>
                                                </td>
                                            </tr>
                                            <!-- end tr -->
                                        </tbody><!-- end tbody -->
